...
public class Numbers {
    ...
    public static void main(String[] args) {
        ...
        /*
         The memory being allocated at run time , checking and everything , which method to run happens at compile time(static polymorphism, early binding)
         */


        /*
         runtime/ Dynamic polymorphism - achieved by method overloading
